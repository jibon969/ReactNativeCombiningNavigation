      ...
      <DrawerItem
        label={() => (
          <View
            ...
            <AntDesign name="leftcircleo" size={20} color="#551E18" />
            {/* <Image source={require('../assets/icon/belaface.png')}
                               resizeMode="cover"
                               style={{maxWidth: '80%', maxHeight: 25, marginLeft: 10}}
                        /> */}
            <Text style={{marginLeft: 10, fontWeight: 'bold'}}> My App</Text>
          </View>
        )}
            ...
            <View style={{flexDirection: 'row'}}>
              ...
              {nestedDrawerItem === true ? (
                <AntDesign
                  name="minus"
                  size={24}
                  color={categoryFocus ? '#551E18' : '#007036'}
                />
              ) : (
                <AntDesign
                  name="plus"
            ...
            <View style={{flexDirection: 'row'}}>
              ...
              {nestedItemDrawerItem === true ? (
                <AntDesign
                  name="minus"
                  size={24}
                  color={nestedFocus ? '#551E18' : '#007036'}
                />
              ) : (
                <AntDesign
                  name="plus"
