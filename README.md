...
```bash
# Create new project
npx react-native init ReactNativeCombiningNavigation

# Using a specific version
npx react-native@X.XX.X init ReactNativeCombiningNavigation --version X.XX.X

#
npx react-native@0.74.3 init ReactNativeCombiningNavigation --version 0.74.3

# change directory
cd ReactNativeCombiningNavigation
...
```bash
git clone git@github.com:jibon969/ReactNativeCombiningNavigation.git
    ...
    <SafeAreaView style={{flex: 1, backgroundColor: '#fff'}}>
      ...
      <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
        ...
        <Text style={{fontSize: 18, fontWeight: '600', color: '#333'}}>
          Current iOS Version: {iosVersion || 'Loading...'}
        </Text>
      </View>
    </SafeAreaView>
  );
